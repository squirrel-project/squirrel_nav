...
// Ugh! boost uniform_01 noise sucks:
...
typedef boost::variate_generator<EngineT&, NormalDistributionT>
    NormalGeneratorT;
/// uniform noise in range [0,1)
typedef boost::variate_generator<EngineT&, UniformDistributionT>
    UniformGeneratorT;
