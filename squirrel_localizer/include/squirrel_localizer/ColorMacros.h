...
#ifndef SQUIRREL_LOCALIZER_COLOR_MACROS_H_
#define SQUIRREL_LOCALIZER_COLOR_MACROS_H_
...
#endif  /* SQUIRREL_LOCALIZER_COLOR_MACROS_H_ */

//
// ColorMacros.h ends here
